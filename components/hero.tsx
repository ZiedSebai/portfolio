...
import { RiNextjsFill,RiVuejsFill, RiReactjsFill, RiTailwindCssFill, RiTwitterXLine } from "react-icons/ri"
      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Zied Sebai</h1>
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Dedicated software developer with a strong focus on
            building efficient, user-friendly applications. Known
            for adaptability, problem-solving, and delivering
            high-quality results across diverse projects.
          </p>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link
              href="https://github.com/ziedsebai/"
              target="_blank"
            >
            ...
            <Link
              href="mailto:ziedsebai20@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/ziedsebai/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
